...
const breathingCat = function() {
  ...
  tl.add( TweenMax.fromTo('.alt-intro', 0.2, {css:{'background': '#5CA1C2'}}, {css:{'background': 'linear-gradient(#494A97, #091A3E)'}} ));
...
const goToWellDone = function() {
  const tl = new TimelineMax();
  tl.add(TweenMax.to('.breathing', 0.2, {css: { display: 'none'}}));
  tl.add( TweenMax.fromTo('.alt-intro', 0.1, {backgroundColor: '#A5E2DA'}, {backgroundColor: '#494A97'}));
